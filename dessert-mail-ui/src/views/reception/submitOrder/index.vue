...
<template>
  <div style="text-align: center;">
    <h1 style="color:rgb(221, 126, 107);  padding-top: 60px;padding-bottom: 20px;">订单详情</h1>
  </div>
  <el-form :label-position="labelPosition" label-width="100px" class="main" style="max-width: 460px">
    ...
    <el-form-item label="收货人">
      <el-input readonly v-model='query.name' />
    </el-form-item>
    <el-form-item label="联系方式">
      <el-input readonly v-model='query.phone' />
    </el-form-item>
    <el-form-item label="收货地址">
      <el-input readonly v-model='query.address' />
    </el-form-item>
    <el-form-item label="订单详情">
      <el-input readonly v-model='query.description' type="textarea" :rows="3" />
    </el-form-item>
    <div class="bottom-btn">
      <el-button type="primary" @click="back()">稍后支付</el-button>
